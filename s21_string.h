...
#define END 0x000
#define BEGIN 0x001  // %
#define FLAGS 0x002  // +-(space)#
#define WIDTH 0x004  // number
#define PRECISION 0x008  // . number
#define LENGTH 0x010  // char
#define SPECIFIER 0x020  // char
#define WORDS_CALLOC 10

#define FLAG_PLUS 0x001
#define FLAG_MINUS 0x002
#define FLAG_SPACE 0x004
...
typedef struct element_spiska {
    t_format format;
    struct  element_spiska *next_element;
} t_element;
...
void s21_spisok_dobavit_element(t_spisok *this_element, t_element *element_format);
